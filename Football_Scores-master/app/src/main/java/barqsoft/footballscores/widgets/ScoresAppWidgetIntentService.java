 ...
 */
public class ScoresAppWidgetIntentService extends IntentService implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public ScoresAppWidgetIntentService() {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        int[] appWidgetIds = appWidgetManager
                .getAppWidgetIds(new ComponentName(this, ScoresApp.class));
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            RemoteViews views = new RemoteViews(getPackageName(), R.layout.scores_app_widget);
